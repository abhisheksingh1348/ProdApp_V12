...
public partial class itemMaster : System.Web.UI.Page
{
    ...
    private static DataSet GetData(SqlCommand cmd, int pageIndex)
   {
    ...
    protected void gvItemMaster_RowEditing(object sender, GridViewEditEventArgs e)
    {

    }

    protected void gvItemMaster_RowCancelingEdit(object sender, GridViewCancelEditEventArgs e)
    {

    }

    protected void gvItemMaster_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
