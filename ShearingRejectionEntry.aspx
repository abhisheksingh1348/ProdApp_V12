<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ShearingRejectionEntry.aspx.cs" Inherits="ShearingRejectionEntry"  EnableEventValidation="false" %>
...
<asp:DropDownList ID="ddlDesc" runat="server" Width="100%">
                    ...
                    <footer class="panel-footer">
                            <asp:Button ID="btn_rej" Text="Reject" class="btn btn-primary" runat="server" OnClick ="btn_rej_Click"  />
