<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="itemMaster.aspx.cs" Inherits="itemMaster" EnableEventValidation="false" %>
...
<hr />
<asp:GridView ID="gvItemMaster" runat="server"  AutoGenerateColumns="false" OnRowDataBound="gvItemMaster_RowDataBound" OnSelectedIndexChanged="gvItemMaster_SelectedIndexChanged">
    <Columns>
