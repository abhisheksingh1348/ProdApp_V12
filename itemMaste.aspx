<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="itemMaste.aspx.cs" Inherits="itemMaste" %>
...
<br />
 ...
 <asp:ListItem Value="CONVENTIONAL">CONV.</asp:ListItem>
                    ...
                    <footer class="panel-footer">
                            <asp:Button ID="btnSave" Text="Save" class="btn btn-primary" runat="server"   />
        ...
        <asp:TemplateField>
            <ItemTemplate>
                <asp:LinkButton Text="Select" ID="lnkSelect" runat="server" CommandName="Select" />
                    ...
                    <asp:GridView ID="gvItemMaster" runat="server"  AutoGenerateColumns="False" OnSelectedIndexChanged="gvItemMaster_SelectedIndexChanged" AllowPaging="true" OnPageIndexChanging="gvItemMaster_PageIndexChanging" PageSize="10" >
    <Columns>
