<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ReductionEntry.aspx.cs" Inherits="ReductionEntry"  EnableEventValidation="false" %>
...
<asp:TextBox ID="txtQty" runat="server" CssClass="form-control"></asp:TextBox>
                    ...
                    <footer class="panel-footer">
                            <asp:Button ID="btn_rej" Text="Reduce" class="btn btn-primary" runat="server" OnClick ="btn_rej_Click"  />
