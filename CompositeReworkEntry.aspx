<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="CompositeReworkEntry.aspx.cs" Inherits="CompositeReworkEntry"  EnableEventValidation="false" %>
...
<br />
                                    ...
                                    <br />
<asp:DropDownList ID="ddlToSection" runat="server" Width="90%"></asp:DropDownList>
...
<asp:TextBox ID="txtQty" runat="server" CssClass="form-control"></asp:TextBox>
                    ...
                    <footer class="panel-footer">
                            <asp:Button ID="btn_rew" Text="Rework" class="btn btn-primary" runat="server" OnClick ="btn_rew_Click"  />

                       
                            <asp:Button ID="btnAddNew" Text="New Entry" class="btn btn-primary" runat="server" OnClick="btnAddNew_Click" Visible="false" />
